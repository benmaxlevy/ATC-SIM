...
- Give ATPA Alert graphics/readouts the adapted `#760A00` color, distinct from
  CA/MSAW red. This is a known divergence from the manual's orange.
...
- ATPA Alert uses `#760A00`; CA/MSAW remains `#BF0000`.
