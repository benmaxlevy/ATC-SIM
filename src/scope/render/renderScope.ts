 ...
 * Current CA displays static `CA` + tone from `world.alerts` and paints red. T04-10 MSAW paints a red `LA` tag when MSL is below the MVA floor; neither tints the block, leader, or target. CA halo is
