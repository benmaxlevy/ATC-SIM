...
import { DisplayControlBar } from "@ui";
import {
...
import { toggleWxLevel } from "../dcb/dcbFunctions";
import { applyDcbShift, openDcbMenu } from "../dcb/dcbMenu";
...
import { createMockCtx, type MockPathStroke } from "./mockCanvas";
...
describe("TPA / ATPA integration and acceptance (T02-50)", () => {
  ...
  describe("AC4: DCB cells, PREF v3, and no Command IR", () => {
    ...
    test("DCB and * chords never emit Command IR; DAL123 H270 still turns", async () => {
      ...
      const bar = (
        import.meta.glob("../../ui/dcb/DisplayControlBar.tsx", {
          query: "?raw",
          import: "default",
          eager: true,
        }) as Record<string, string>
      )["../../ui/dcb/DisplayControlBar.tsx"]!;
