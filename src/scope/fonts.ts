 ...
 * STARS face (`phases/_shared/non-goals.md`). DCB CHAR SIZE cycles 11–13 px
 * on this same stack. Not NAS STARS.
 */
...
/** DCB CHAR SIZE steps (datablock + DCB). Still Plex / system mono. */
