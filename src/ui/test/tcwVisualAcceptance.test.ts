...
import { DisplayControlBar } from "../dcb/DisplayControlBar";
import { DISCLAIMER_COPY, Disclaimer } from "../overlays/disclaimer";
import { FlightStrips } from "../strips/FlightStrips";
...
test("AC5 — persistent chrome has no zoom/label/sprite/OSM/HUD; DCB WX1–6 latch; PREF allowed; no CSA/CRDA/FMA clone", () => {
  ...
  expect(uiSources["../dcb/DisplayControlBar.tsx"]!).not.toMatch(
  ...
  expect(uiSources["../dcb/DisplayControlBar.tsx"]!).not.toMatch(/nexrad|mosaic|openstreetmap/i);
