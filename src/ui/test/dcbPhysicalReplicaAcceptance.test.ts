...
import { DisplayControlBar, MAIN_DCB_LAYOUT } from "../dcb/DisplayControlBar";
...
test("AC1 — MAIN renders six WX latches, enabled SITE, inert MODE FSL", () => {
  const html = dcbHtml();
...
test("AC5 — copy and typography remain a STARS-like trainer approximation", () => {
  const source = readFileSync(new URL("../dcb/DisplayControlBar.tsx", import.meta.url), "utf8");
