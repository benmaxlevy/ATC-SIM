...
- [x] Trailing track paints one unfilled wedge (vertex on the trailer, axis toward the leader, length = `requiredNm`); monitor TPA blue, warning `atpaWarning` yellow, alert `atpaAlert` orange — never CA red `PALETTE.alert` (T02-45).
