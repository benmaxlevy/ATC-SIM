  ...
  },
  {
    ...
    entries: [
      ...
      },
      {
        ...
        result:
          "ATC-SIM trainer extension (not a supplied STARS-manual function): open a local filed flight-plan dialog by ACID, current visible TAB index, or bare *FP target slew; target slew opens the uniquely beacon-correlated plan or creates a draft only when no filed plan exists, while beacon mismatch, stale/off-page TAB, or blank-ACID targets return NO FLIGHT. The dialog keeps ACID immutable, uppercases editable text, validates bare-token routes against the scenario catalog, and displays H/ for known heavy aircraft types; filed data never activates aircraft guidance.",
      },
    ],
  },
  {
