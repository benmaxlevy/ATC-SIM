...
Route sequence form: `cleared to KATL via direct CEDAR direct` is an IFR_CLEARANCE with FIX_THEN_DIRECT and fixId CEDAR. Treat the first direct as the route leg to the listed fix and the final direct as continuation to the clearance limit.
